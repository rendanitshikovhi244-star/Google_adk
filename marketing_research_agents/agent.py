import os
# LLM Agent = dynamic, decides what to do
# Workflow Agent = predefined, follows a script
# Temperature controls how creative vs. predictable the LLM's responses are. It's a value between 0.0 and 2.0:
try:
    from dotenv import load_dotenv
    load_dotenv()

    MODEL_NAME = os.environ.get("MODEL", "gemini-2.5-flash-lite")
except ImportError:
...
from marketing_research_agents.instruction import (
